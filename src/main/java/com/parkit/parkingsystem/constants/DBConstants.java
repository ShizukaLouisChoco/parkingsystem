...
public class DBConstants {
    ...
    public static String vehicleRegNumber =ticket.getVehicleRegNumber();
    ...
    public static final String COUNT_TICKETS = "select count(VEHICLE_REG_NUMBER) from ticket where VEHICLE_REG_NUMBER = "+ vehicleRegNumber + " and OUT_TIME IS NOT NULL";
}
